...
public class  BidentSet extends Command {
    ...
    public BidentSet(double Inches) {
    ...
    protected void initialize() {
    	Robot.bident.setHeight(height);
    	System.out.println("Bident::Set::Setting height to "+height);
    }
    ...
    protected void end() {
    	System.out.println("Bident::Set::Complete: Specified "+height+", exited at "+Robot.bident.getHeight());
    }
